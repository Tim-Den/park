...
Java_com_dream_park_utils_PlateRecognition_InitPlateRecognizer(
...
Java_com_dream_park_utils_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_com_dream_park_utils_PlateRecognition_ReleasePlateRecognizer(JNIEnv *env, jobject obj,
                                                                  jlong object_re) {
